...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./mnt/dados/3-ano-2-semestre/projecto-final-aw/nzolanet-back/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./mnt/dados/3-ano-2-semestre/projecto-final-aw/nzolanet-back/public/storage','logging.default','logging.deprecations.channel',
...
'session.http_only','session.same_site','session.partitioned','session.serialization','l5-swagger.default',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','L5_SWAGGER_GENERATE_ALWAYS','L5_SWAGGER_USE_ABSOLUTE_PATH',
